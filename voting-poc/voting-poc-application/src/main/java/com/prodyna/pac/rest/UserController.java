...
public class UserController extends AbstractController {
    ...
    /*    UserDTO persisted = service.create(data);
		...
		dto.setEmail("email@lala.de");
		dto.setAdministrator(false);
		dto.setCreationDate(new Date());
        
        ResponseEntity<UserDTO> responseEntity = new ResponseEntity<UserDTO>(dto,  HttpStatus.OK);
        return responseEntity;
...
*/
  ...
  */      
		...
		dto2.setEmail("email2@lala.de");
		dto2.setAdministrator(true);
		dto2.setCreationDate(new Date());
		
		response.add(dto);
		response.add(dto2);

		ResponseEntity<List<UserDTO>> responseEntity = new ResponseEntity<List<UserDTO>>(response, HttpStatus.OK);
		return responseEntity;
    }
