...
public class User {
    ...
    public String toString() {
        return "User [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", password=" + password + ", administrator=" + administrator + ", selections="
                + selections + ", creationDate=" + creationDate + "]";
    }
