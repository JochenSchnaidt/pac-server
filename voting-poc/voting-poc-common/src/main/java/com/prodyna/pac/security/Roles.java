...
public class Roles {
    ...
    /**
     * Spring security has role expression for {@code PreAuthorize} of role 'Trainer' from ebiz.
     */
    public static final String HAS_ROLE_USER          = "hasRole('" + ROLE_USER + "')";

    /**
     * Spring security has role expression for {@code PreAuthorize} of role 'Administrator' from ebiz.
     */
